...
function ToolsToggle(props) {
    ...
    const handlClicks = (index) => {
        ...
        switch (index) {
            ...
            case 1: setToolsLogos(<UIUXTools />); scrolling(index, 150); break;
            case 2: setToolsLogos(<DigitalMarketingTools />); scrolling(index, 100); break;
            case 3: setToolsLogos(<FullStackDevelopmentTools />); scrolling(index, 200); break;
