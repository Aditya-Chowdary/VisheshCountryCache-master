    ...
    <div className='footer-section'>
      ...
      <div className='last-section1'>
        <div className='footer-section-color'>
          ...
          <h4 onClick={() => {navigate('/contact')}} className='footer-section-text3'>Become a Client <img src={ArrowRight} className='footer-section-icon' alt='arrow-icon' /></h4>
        </div>
      ...
      <div className='last-section'>
        <p className='last-text' onClick={() => { navigate('/privacy-policy') }}>PRIVACY POLICY</p>
